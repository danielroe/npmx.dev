...
<template>
  <section v-if="status === 'success' && hasDeprecated" class="relative">
    <div class="rounded-lg border overflow-hidden" :class="bannerColor">
      ...
      <button
        type="button"
        class="w-full flex items-center justify-between gap-3 px-4 py-3 text-start transition-colors duration-200 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent/50"
