    ...
    <table class="w-full text-start">
      <thead class="border-b border-border">
        <tr>
          ...
          <th
            scope="col"
            class="table-th focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-inset focus-visible:outline-none"
            :class="{
          ...
          <th v-if="isColumnVisible('version')" scope="col" class="table-th">
            {{ $t(getColumnLabelKey('version')) }}
          </th>

          <th v-if="isColumnVisible('description')" scope="col" class="table-th">
          ...
          <th
            ...
            scope="col"
            class="table-th text-end focus-visible:ring-2 focus-visible:ring-fg focus-visible:ring-inset focus-visible:outline-none"
            :class="{
          ...
          <th v-if="isColumnVisible('maintainers')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('maintainers')) }}
          </th>

          <th v-if="isColumnVisible('keywords')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('keywords')) }}
          </th>

          <th v-if="isColumnVisible('qualityScore')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('qualityScore')) }}
          </th>

          <th v-if="isColumnVisible('popularityScore')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('popularityScore')) }}
          </th>

          <th v-if="isColumnVisible('maintenanceScore')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('maintenanceScore')) }}
          </th>

          <th v-if="isColumnVisible('combinedScore')" scope="col" class="table-th text-end">
            {{ $t(getColumnLabelKey('combinedScore')) }}
          </th>

          <th v-if="isColumnVisible('security')" scope="col" class="table-th text-end">
