        ...
        <div>
          ...
          <ul class="flex flex-wrap gap-2 md:gap-x-6 md:gap-y-4 list-none p-0 -mx-2">
            <li v-for="sponsor in SPONSOR" :key="sponsor.name">
              <a :href="sponsor.url" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center h-full min-w-13 rounded-md hover:bg-fg/10 transition-colors p-2">
                <img :src="sponsor.logo" loading="lazy" height="24" width="auto" :alt="sponsor.name" class="h-6 md:h-9 w-auto block" />
              </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="flex flex-wrap gap-2 md:gap-4 list-none p-0 -mx-2">
            <li v-for="partner in OSS_PARTNERS" :key="partner.name">
              <a :href="partner.url" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center h-full min-w-10 md:min-w-13 rounded-md hover:bg-fg/10 transition-colors p-2">
                <img :src="partner.logo" loading="lazy" height="24" width="auto" :alt="partner.name" class="h-6 md:h-9 w-auto block" />
              </a>
            </li>
          </ul>
        </div>
